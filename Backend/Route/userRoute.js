...
import { fetch, create, fetchBuyers, update, deleteInfo, login, register } from '../controller/userController.js'
...
route.get("/getAllBuyers", fetchBuyers);
route.post("/createUser", create);
route.put("/updateUser/:id", update);
route.delete("/deleteUser/:id", deleteInfo);
